...
%%NTESPARAMS
% NTESPARAMS returns the neurite dimensions pyhsiological parameters
% defined below.
%
% Created by: Tim Esler, 2015

p.b = 0.5e-6; %  + 0.5e-6;                       % NTES radius (m)
p.d = 0.03e-6; % + 0.5e-6;                      % Width of extracellular sheath (m)
...
p.r_e = p.rho_e/(pi*p.d^2);         % Extracellular resistance (ohm/m)
